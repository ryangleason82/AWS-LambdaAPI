...
const MONGODB_URI = "mongodb+srv://ryan:ryan1234@cluster0-vitvy.mongodb.net/test?retryWrites=true";

function connectToDatabase(MONGODB_URI){
    console.log('Connected to DB');
    return MongoClient.connect(MONGODB_URI)
}

exports.handler = (app, db) => {
